...
for j = 1:J
    ...
    for k = 1:K
        ...
        [stics_img{j,k},o] = bead_test2(opt(j));
...
%% Convection model - use this for grid representation of fitted velocities
...
V = axis;
axis([V(1) V(2) 0 1])
title('Bayesian model probabilities for PSF size 0.3 \mum. D = 0 \mum^2/s. SNR = Inf');
...
title('Bayes with normalized STICS. SNR = Inf')

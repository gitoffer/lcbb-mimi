...
filename = '~/Desktop/Clustering results/corrected_area_norm/kmeans_c5_pearson.txt';
...
mkdir('~/Desktop/Clustering results/corrected_area_norm/');
filename = '~/Desktop/Clustering results/corrected_area_norm.csv';

...
%
% SYNOPSIS: [neighbor,same] = draw_random_neighbor(lattice,cell)
%
...
%         same - whether the cell and neighbor pixels belong to the same
%                cell
%
...
%-----Tries to wrap the lattice around itself -- DO NOT USE!
...
flag = 0;
if lattice(neighbor_i,neighbor_j) == lattice(cell_n,cell_m)
    flag = 1;
end
...
%------ below is code for picking only 'nonself' neighboring pixels...
